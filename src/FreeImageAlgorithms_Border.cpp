...
template<class Tsrc> class BORDER
{
    public:
        ...
        FIABITMAP * SetBorder(FIBITMAP *src, int xborder, int yborder, BorderType type,
                Tsrc constant);
};

static inline void CopyImageRow(FIBITMAP *src, int src_row, int row_start, int count)
{
...
static inline void CopyImageCol(FIBITMAP *src, int src_col, int col_start, int count)
{
...
template <typename Tsrc> inline void BORDER<Tsrc>::SetImageRowToConstant(FIBITMAP *src,
        int row_start, int count, Tsrc val)
{
...
template <typename Tsrc> inline void BORDER<Tsrc>::SetImageColToConstant(FIBITMAP *src,
        int col_start, int count, Tsrc val)
{
    int height = FreeImage_GetHeight(src);
    int pitch = FreeImage_GetPitch(src);
...
template <typename Tsrc> FIABITMAP* BORDER<Tsrc>::SetBorder(FIBITMAP *src, int xborder,
        int yborder, BorderType type, Tsrc constant)
{
    int width = FreeImage_GetWidth(src);
    int height = FreeImage_GetHeight(src);
