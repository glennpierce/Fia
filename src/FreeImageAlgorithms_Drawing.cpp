...
static void draw_line(agg::rasterizer& ras, double x1, double y1, double x2, double y2, double width)
{
    double dx = x2 - x1;
    double dy = y2 - y1;
...
template <typename valType> static int orthogonal_draw_gs_line(FIBITMAP *src, int x1, int y1,
